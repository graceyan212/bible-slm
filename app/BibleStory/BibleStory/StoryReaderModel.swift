...
struct StoryContent: Decodable, Equatable {
    ...
    static func assetName(forArtPath path: String) -> String {
        ...
        case "jonah_p1":       return "StoryJonahP1"
        case "jonah_p2":       return "StoryJonahP2"
        case "jonah_p3":       return "StoryJonahP3"
        case "jonah_p4":       return "StoryJonahP4"
        case "christmas_p1":   return "StoryFirstChristmasP1"
        case "christmas_p2":   return "StoryFirstChristmasP2"
        case "christmas_p3":   return "StoryFirstChristmasP3"
        case "daniel_p1":      return "StoryDanielLionsP1"
        case "daniel_p2":      return "StoryDanielLionsP2"
        case "daniel_p3":      return "StoryDanielLionsP3"
        case "shepherd_p1":    return "StoryGoodShepherdP1"
        case "shepherd_p2":    return "StoryGoodShepherdP2"
        case "shepherd_p3":    return "StoryGoodShepherdP3"
        case "david_p1":       return "StoryDavidGoliathP1"
        case "david_p2":       return "StoryDavidGoliathP2"
        case "david_p3":       return "StoryDavidGoliathP3"
        case "david_p4":       return "StoryDavidGoliathP4"
        case "david_p5":       return "StoryDavidGoliathP5"
        case "easter_p1":      return "StoryEasterP1"
        case "easter_p2":      return "StoryEasterP2"
        case "easter_p3":      return "StoryEasterP3"
        case "easter_p4":      return "StoryEasterP4"
        case "prodigal_p1":    return "StoryProdigalSonP1"
        case "prodigal_p2":    return "StoryProdigalSonP2"
        case "prodigal_p3":    return "StoryProdigalSonP3"
        case "prodigal_p4":    return "StoryProdigalSonP4"
        case "zacchaeus_p1":   return "StoryZacchaeusP1"
        case "zacchaeus_p2":   return "StoryZacchaeusP2"
        case "zacchaeus_p3":   return "StoryZacchaeusP3"
